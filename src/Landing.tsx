...
export function Lander() {
    return (
        <>
            ...
            <div style={{ margin: '100px 50px', padding: '0 20px' }}>
                <Grid container spacing={3}>
                    <Grid item xs={12} sm={6}>
                        <div style={{ display: 'flex', justifyContent: 'left' }}>
                            <div>
                                <Typography variant='h2' style={{ fontWeight: 1000, fontFamily: 'Helvetica', lineHeight: 1.2 }}>Women's</Typography> 
                                <Typography variant='h2' style={{ marginBottom: 0, fontWeight: 1000, fontFamily: 'Helvetica', lineHeight: 1.2 }}>Hygiene?</Typography>
                            </div>
                        </div>
                        <br />
                        ...
                        <Typography
                            ...
                            style={{
                                ...
                                textAlign: 'justify',
                                maxWidth: '100%', // Adjust for mobile screens
                            }}
                        >
                    ...
                    <Grid item xs={12} sm={6} style={{ textAlign: 'center' }}>
                        <img src="https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhKVnloOeAmvsWZKDxr-Aw7az3IV5RuOMNPd54-nTdBUzpLTKvcrS8ppq7s3de-dUFMrSrufihhsHzkHM1WsiIRPLsEZYZsWKIfrb2hLL_eHEzUtfRE5KwyjqHggMaP_gU5fh2Hr_wcEtTwSbZLbTLPLJAZKtMiV9_xvvJIGdbDwujRRh_KYHvhBGj3RIE/s590/pieFem.png" 
                            alt="Pie chart" 
                            style={{ width: '100%', height: 'auto', maxWidth: '400px' }} // Ensures proper scaling for mobile
                        />
            ...
            <br /><br /><br />
            <div>
                <Typography variant='h2' style={{ fontWeight: 1000, fontFamily: 'Helvetica', textAlign: 'justify', marginLeft: 20, marginTop: 50, color: '#633EBB' }}>
